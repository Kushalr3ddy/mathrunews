...
/* real brand SVG glyphs (24x24, currentColor) */
const SOCIAL_SVG = {
...
function socialIcon(name) { return `<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true">${SOCIAL_SVG[name]}</svg>`; }
function socialRow(b) {
  return `<div class="foot-social" style="margin-top:6px">
    <a href="#" aria-label="Facebook" title="Facebook">${socialIcon("facebook")}</a>
    <a href="#" aria-label="YouTube" title="YouTube">${socialIcon("youtube")}</a>
    <a href="#" aria-label="X" title="X">${socialIcon("x")}</a>
    <a href="#" aria-label="Instagram" title="Instagram">${socialIcon("instagram")}</a>
    <a href="https://wa.me/${b.phoneRaw}" aria-label="WhatsApp" title="WhatsApp">${socialIcon("whatsapp")}</a>
  </div>`;
}
